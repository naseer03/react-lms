...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary uses CSS variables so the admin can change the brand color
        // from Settings → Institute Branding without a redeploy.
        // Defaults are set in index.css :root and overridden at runtime by SettingsContext.
        primary: {
